...
export class TSaleTrendReport extends TReportsAction {
    constructor(dataSource: DataSourceType, instanceRefs: any) {
        ...
        this.TableConfig = Object.assign(this.TableConfig, {
            id: 'ReportsViews-AnalysisReports-SaleTrendReport',
            sep: true,
            expand: false,
            opt: false,
            parger: true,
        ...
        this.SerachBoxConfig = $Utils.deepObjectMerge(this.SerachBoxConfig, {
            fields: [{ fieldName: "catecode", caption: "分类", filterType: "fsIn", inList: this.commonDatas.CateDatas }],
        });
