...
defineOptions({
    name: 'AnalysisReports/YonYReport'
})
...
const handleApplay = async () => {
    ...
    const res = await $api.comonRequest('/masterApi/disApi/reports/AnalysisReports/YonYReport/', 'buildReport', {
    ...
    if (res.errCode == 0) {
        const rs = await $api.comonRequest('/masterApi/disApi/reports/AnalysisReports/YonYReport/', 'get', {})
