...
export class TSalesManSaleReport extends TReportsAction {
    constructor(dataSource: DataSourceType, instanceRefs: any) {
        ...
        this.TableConfig = Object.assign(this.TableConfig, {
            id: 'ReportsViews-SaleReprots-SalesManSaleReport',
            sep: true,
            expand: false,
            opt: false,
            parger: true,
        ...
        this.SerachBoxConfig = $Utils.deepObjectMerge(this.SerachBoxConfig, {
            fields: [{ fieldName: "usercode", caption: "业务", filterType: "fsIn", inList: this.commonDatas.UserDatas }],
        })
