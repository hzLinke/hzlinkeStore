...
const dataSource = reactive(
    new TDataSource({
        ...
        getParmars: { sortFields: 'deliveryAt,Idkey', totalFieldSql: 'count(productcode) as count,sum(numEx) as Num,sum(sumMoney) as sumMoney,sum(ActualSumMoney) as ActualSumMoney' }
    })
)
