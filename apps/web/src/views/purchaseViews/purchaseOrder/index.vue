...
import type { PurchaseOrderInstanceRefs } from './types'
...
const listDataSource = reactive(
    new TDataSource({
            ApiPath: '/masterApi/disApi/purchase/purchaseOrder/BillList/',
...
const detailDataSource = reactive(
    new TDataSource({
            ApiPath: '/masterApi/disApi/purchase/purchaseOrder/BillDetail/',
            KeyFieldName: 'IdKey',
            NotAllowOperationList: [],
...
const instanceRefs = markRaw<PurchaseOrderInstanceRefs>({
    detailVisabled,
    headerData,
    headerDisabled,
    userCode,
...
const Win = reactive(new TWinForm<PurchaseOrderInstanceRefs>(instanceRefs))
