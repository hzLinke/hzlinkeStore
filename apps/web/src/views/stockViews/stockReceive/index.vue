...
import type { StockReceiveInstanceRefs } from './types'
...
const listDataSource = reactive(
    new TDataSource({
            ApiPath: '/masterApi/disApi/stocks/stockReceive/BillList/',
...
const detailDataSource = reactive(
    new TDataSource({
            ApiPath: '/masterApi/disApi/stocks/stockReceive/BillDetail/',
            KeyFieldName: 'IdKey',
            NotAllowOperationList: [],
...
const instanceRefs = markRaw<StockReceiveInstanceRefs>({
    detailVisabled,
    headerData,
    headerDisabled,
    userCode,
...
const Win = reactive(new TWinForm<StockReceiveInstanceRefs>(instanceRefs))
