...
import type { StockReceiveReportInstanceRefs } from './types'

defineOptions({
    name: 'reports/stockReceiveReport'
})
...
const dataSource = reactive(
    new TDataSource({
            ApiPath: '/masterApi/disApi/stocks/Reports/stockReceiveReport/',
...
const instanceRefs = markRaw<StockReceiveReportInstanceRefs>({
    detailDataSource: null
})

const Win = reactive(new TWinForm<StockReceiveReportInstanceRefs>(instanceRefs))
