    ...
    >
        ...
        <template #funcToolsbar>
            <div class="funcToolsBar"> 
                <ToolsBar class="toolsBar" :toolsBarItems="gridDetailAction.toolsBarItems" :showIcon="false" @itemClick = "gridDetailAction.ToolsBarItemClick"/>
...
import type { StockAreaSwapInstanceRefs } from './types'
...
const listDataSource = reactive(
    new TDataSource({
            ApiPath: '/masterApi/disApi/stocks/stockAreaSwap/BillList/',
...
const detailDataSource = reactive(
    new TDataSource({
            ApiPath: '/masterApi/disApi/stocks/stockAreaSwap/BillDetail/',
            KeyFieldName: 'IdKey',
            NotAllowOperationList: [],
...
const instanceRefs = markRaw<StockAreaSwapInstanceRefs>({
    detailVisabled,
    headerData,
    headerDisabled,
    userCode,
...
const Win = reactive(new TWinForm<StockAreaSwapInstanceRefs>(instanceRefs))
        ...
        [
            {
                ...
                config: {
                    ...
                    inputType: 'drop',
                    onChange: (data: any) => {
                        gridAction.dataSource.setFieldValue('outareacode', data.idcode)
                    }
                },
                dropConfig: {
                    allowInput: false,
        ...
        [
            {
                ...
                config: {
                    ...
                    inputType: 'drop',
                    onChange: (data: any) => {
                        gridAction.dataSource.setFieldValue('inareacode', data.idcode)
                    }
                },
                dropConfig: {
                    allowInput: false,
