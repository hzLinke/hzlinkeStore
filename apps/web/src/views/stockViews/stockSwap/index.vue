...
import type { StockSwapInstanceRefs } from './types'
...
const listDataSource = reactive(
    new TDataSource({
            ApiPath: '/masterApi/disApi/stocks/stockSwap/BillList/',
...
const detailDataSource = reactive(
    new TDataSource({
            ApiPath: '/masterApi/disApi/stocks/stockSwap/BillDetail/',
            KeyFieldName: 'IdKey',
            NotAllowOperationList: [],
...
const instanceRefs = markRaw<StockSwapInstanceRefs>({
    detailVisabled,
    headerData,
    headerDisabled,
    userCode,
...
const Win = reactive(new TWinForm<StockSwapInstanceRefs>(instanceRefs))
