...
const instanceRefs = markRaw<RecReportsInstanceRefs>({
    userCode: userCode
})

const Win = reactive(new TWinForm<RecReportsInstanceRefs>(instanceRefs))

const dataSource = reactive(
    new TDataSource({
        ApiPath: '/masterApi/disApi/finance/reports/recReports/',
