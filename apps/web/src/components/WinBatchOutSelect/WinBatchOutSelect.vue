...
import {  BatchOutSelectInstanceRefs, BatchOutSelectOptions } from './types'

defineOptions({
    name: 'WinBatchOutSelect'
})

const props = withDefaults(defineProps<BatchOutSelectOptions>(), {
    customerCode: 0,
    shipperCode: 0,
    billType: 'sale',
