...
import { InHistoryInfBoxOptions } from './types'

defineOptions({
    name: 'WinInHistoryInfBox'
})

const props = withDefaults(defineProps<InHistoryInfBoxOptions>(), {
    width: 850,
    height: 400
})

const lkxGrid = ref<null | HTMLElement>(null)
const ApiPath =  '/masterApi/disApi/purchase/reports/purchaseReports/'
...
const gridAction = reactive(new TAction(dataSource, props.commonDatas))
